            ...
            <div className="relative w-full">
                <label
                    className={cn(
                        ...
                        { "-translate-y-[23px] -translate-x-0.5 scale-[83%] text-zinc-950 dark:text-zinc-300": focused || hasValue }
                    )}
                >
                    {label}
                </label>
