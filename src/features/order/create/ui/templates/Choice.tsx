    ...
    return (
        ...
        >
            ...
            <div className='flex items-center justify-center flex-col'>
                <Image loading={'eager'} fetchPriority={'high'} priority className='w-24 sm:w-40 md:w-48 lg:w-56' placeholder={'blur'} draggable={false} src={props.imgSrc} alt={'firstChoice'} width={224} height={224}/>
