        ...
        <div className="flex items-center justify-center flex-col" vaul-drawer-wrapper="">
            ...
            >
                <div className='flex items-center gap-3'>
                    ...
                    <h1 className="font-semibold text-2xl sm:text-2xl">Уведомления</h1>
                </div>
                <div className='p-6 mt-4 rounded-3xl bg-zinc-900/80 relative overflow-hidden'>
                    ...
                    <div className='p-3 z-50 px-4 relative rounded-2xl bg-black/30 backdrop-blur flex gap-4 justify-between items-center'>
                        <div>
                    ...
                    <div className='p-3 z-50 px-4 relative rounded-2xl bg-black/30 backdrop-blur mt-5 flex gap-4 justify-between items-center'>
                        <div>
